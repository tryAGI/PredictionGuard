...
namespace PredictionGuard
{
    public partial class PredictionGuardClient
    {
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement s_CreateChatCompletionsSecurityRequirement0 =
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement[] s_CreateChatCompletionsSecurityRequirements =
            new global::PredictionGuard.EndPointSecurityRequirement[]
            {                s_CreateChatCompletionsSecurityRequirement0,
            };
        partial void PrepareCreateChatCompletionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::PredictionGuard.CreateChatCompletionsRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.CreateChatCompletionsResponse3> CreateChatCompletionsAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PredictionGuard.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.CreateChatCompletionsResponse3>> CreateChatCompletionsAsResponseAsync(
                ...
                else
                {
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::PredictionGuard.CreateChatCompletionsResponse? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::PredictionGuard.CreateChatCompletionsResponse.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.CreateChatCompletionsResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::PredictionGuard.CreateChatCompletionsResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::PredictionGuard.CreateChatCompletionsResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.CreateChatCompletionsResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PredictionGuard.CreateChatCompletionsResponse3.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.CreateChatCompletionsResponse3>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PredictionGuard.CreateChatCompletionsResponse3.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.CreateChatCompletionsResponse3> CreateChatCompletionsAsync(
            string model,
            global::PredictionGuard.OneOf<string, global::System.Collections.Generic.IList<global::PredictionGuard.CreateChatCompletionsRequestMessagesVariant2Item>> messages,
            double? frequencyPenalty = default,
            global::PredictionGuard.CreateChatCompletionsRequestLogitBias? logitBias = default,
            ...
            bool? stream = default,
            global::PredictionGuard.CreateChatCompletionsRequestStreamOptions? streamOptions = default,
            double? temperature = default,
            global::PredictionGuard.OneOf<string, global::PredictionGuard.CreateChatCompletionsRequestToolChoice>? toolChoice = default,
            global::System.Collections.Generic.IList<global::PredictionGuard.CreateChatCompletionsRequestTool>? tools = default,
            double? topP = default,
            int? topK = default,
            global::PredictionGuard.CreateChatCompletionsRequestOutput? output = default,
            global::PredictionGuard.CreateChatCompletionsRequestInput? input = default,
            int? maxTokens = default,
            global::PredictionGuard.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PredictionGuard.CreateChatCompletionsRequest
            {
                Model = model,
                Messages = messages,

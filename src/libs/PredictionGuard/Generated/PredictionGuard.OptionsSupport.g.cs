...
namespace PredictionGuard
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::PredictionGuard.AutoSDKRetryOptions Retry { get; set; } = new global::PredictionGuard.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::PredictionGuard.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::PredictionGuard.IAutoSDKHook>();
        ...
        public global::PredictionGuard.AutoSDKClientOptions AddHook(
            global::PredictionGuard.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::PredictionGuard.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::PredictionGuard.AutoSDKClientOptions UseAuthorizationProvider(
            global::PredictionGuard.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::PredictionGuard.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::PredictionGuard.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::PredictionGuard.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::PredictionGuard.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::PredictionGuard.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::PredictionGuard.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::PredictionGuard.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::PredictionGuard.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::PredictionGuard.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::PredictionGuard.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::PredictionGuard.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::PredictionGuard.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::PredictionGuard.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::PredictionGuard.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::PredictionGuard.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::PredictionGuard.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::PredictionGuard.AutoSDKClientOptions clientOptions,
            global::PredictionGuard.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::PredictionGuard.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::PredictionGuard.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::PredictionGuard.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::PredictionGuard.AutoSDKClientOptions clientOptions,
            global::System.Func<global::PredictionGuard.IAutoSDKHook, global::PredictionGuard.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::PredictionGuard.AutoSDKHookContext context)
        {

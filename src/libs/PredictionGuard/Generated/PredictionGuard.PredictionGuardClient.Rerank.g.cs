...
namespace PredictionGuard
{
    public partial class PredictionGuardClient
    {
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement s_RerankSecurityRequirement0 =
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement[] s_RerankSecurityRequirements =
            new global::PredictionGuard.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.RerankResponse200> RerankAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PredictionGuard.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.RerankResponse200>> RerankAsResponseAsync(
                ...
                else
                {
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::PredictionGuard.RerankRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::PredictionGuard.RerankRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::PredictionGuard.ApiException<global::PredictionGuard.RerankRequestBadRequestError>(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::PredictionGuard.RerankRequestForbiddenError? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::PredictionGuard.RerankRequestForbiddenError.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::PredictionGuard.ApiException<global::PredictionGuard.RerankRequestForbiddenError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PredictionGuard.RerankResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.RerankResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PredictionGuard.RerankResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

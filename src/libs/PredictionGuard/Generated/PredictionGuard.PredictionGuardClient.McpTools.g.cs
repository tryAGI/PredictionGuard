...
namespace PredictionGuard
{
    public partial class PredictionGuardClient
    {
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement s_McpToolsSecurityRequirement0 =
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement[] s_McpToolsSecurityRequirements =
            new global::PredictionGuard.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.McpToolsResponse200> McpToolsAsync(
            global::PredictionGuard.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await McpToolsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PredictionGuard.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.McpToolsResponse200>> McpToolsAsResponseAsync(
            global::PredictionGuard.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                ...
                else
                {
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::PredictionGuard.McpToolsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::PredictionGuard.McpToolsRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.McpToolsRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::PredictionGuard.McpToolsRequestForbiddenError? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::PredictionGuard.McpToolsRequestForbiddenError.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.McpToolsRequestForbiddenError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PredictionGuard.McpToolsResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.McpToolsResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PredictionGuard.McpToolsResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

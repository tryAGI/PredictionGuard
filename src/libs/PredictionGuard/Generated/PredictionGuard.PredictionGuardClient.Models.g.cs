...
namespace PredictionGuard
{
    public partial class PredictionGuardClient
    {
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement s_ModelsSecurityRequirement0 =
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement[] s_ModelsSecurityRequirements =
            new global::PredictionGuard.EndPointSecurityRequirement[]
            {                s_ModelsSecurityRequirement0,
            };
        partial void PrepareModelsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::PredictionGuard.ModelsCapabilityGetParametersCapability? capability);
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.ModelsResponse200> ModelsAsync(
            global::PredictionGuard.ModelsCapabilityGetParametersCapability? capability,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PredictionGuard.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.ModelsResponse200>> ModelsAsResponseAsync(
            global::PredictionGuard.ModelsCapabilityGetParametersCapability? capability,
            global::PredictionGuard.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                else
                {
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::PredictionGuard.ModelsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::PredictionGuard.ModelsRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.ModelsRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::PredictionGuard.ModelsRequestForbiddenError? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::PredictionGuard.ModelsRequestForbiddenError.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.ModelsRequestForbiddenError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PredictionGuard.ModelsResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.ModelsResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PredictionGuard.ModelsResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace PredictionGuard
{
    public partial class PredictionGuardClient
    {
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement s_CreateDocumentsExtractSecurityRequirement0 =
        ...
        private static readonly global::PredictionGuard.EndPointSecurityRequirement[] s_CreateDocumentsExtractSecurityRequirements =
            new global::PredictionGuard.EndPointSecurityRequirement[]
            {                s_CreateDocumentsExtractSecurityRequirement0,
            };
        partial void PrepareCreateDocumentsExtractArguments(
            ...
            ref bool? injection,
            global::PredictionGuard.CreateDocumentsExtractRequest request);
        partial void PrepareCreateDocumentsExtractRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? injection,
            global::PredictionGuard.CreateDocumentsExtractRequest request);
        partial void ProcessCreateDocumentsExtractResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDocumentsExtractResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.CreateDocumentsExtractResponse3> CreateDocumentsExtractAsync(
        ...
        {
            var __response = await CreateDocumentsExtractAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PredictionGuard.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.CreateDocumentsExtractResponse3>> CreateDocumentsExtractAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDocumentsExtractArguments(
            ...
            var __authorizations = global::PredictionGuard.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDocumentsExtractSecurityRequirements,
                operationName: "CreateDocumentsExtractAsync");
            ...
            if (injection != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDocumentsExtractRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PredictionGuard.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createDocumentsExtract",
                                methodName: "CreateDocumentsExtractAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDocumentsExtractResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::PredictionGuard.CreateDocumentsExtractResponse? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::PredictionGuard.CreateDocumentsExtractResponse.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.CreateDocumentsExtractResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::PredictionGuard.CreateDocumentsExtractResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::PredictionGuard.CreateDocumentsExtractResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.CreateDocumentsExtractResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDocumentsExtractResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PredictionGuard.CreateDocumentsExtractResponse3.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.CreateDocumentsExtractResponse3>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PredictionGuard.CreateDocumentsExtractResponse3.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.CreateDocumentsExtractResponse3> CreateDocumentsExtractAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PredictionGuard.CreateDocumentsExtractRequest
            {
                File = file,
                Filename = filename,
            ...
            return await CreateDocumentsExtractAsync(
                toxicity: toxicity,
                pii: pii,
                replaceMethod: replaceMethod,
                entityList: entityList,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::PredictionGuard.CreateDocumentsExtractRequest
            {
                    ...
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::PredictionGuard.CreateDocumentsExtractResponse3.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::PredictionGuard.CreateDocumentsExtractResponse3.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {

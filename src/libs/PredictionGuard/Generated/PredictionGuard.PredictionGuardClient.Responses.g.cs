...
namespace PredictionGuard
{
    public partial class PredictionGuardClient
    {
        ...
        {
            var __response = await ResponsesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PredictionGuard.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.ResponsesResponse200>> ResponsesAsResponseAsync(
                ...
                else
                {
                    await global::PredictionGuard.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.ResponsesRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::PredictionGuard.ApiException<global::PredictionGuard.ResponsesRequestForbiddenError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PredictionGuard.ResponsesResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PredictionGuard.AutoSDKHttpResponse<global::PredictionGuard.ResponsesResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PredictionGuard.ResponsesResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
